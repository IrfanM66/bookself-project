...
function HomePage() {
  ...
  return (
    <div className="main-page">
      <section>
        <h2 className="bookself-title">Bookself</h2>
        <p className="bookself-desc">
          Bookself adalah sebuah aplikasi catatan online yang memungkinkan
          pengguna untuk dengan mudah menyimpan, mengatur dan berbagi catatan
          mereka dengan efisien.
        </p>
        <SearchBar keyword={keyword} keywordChange={onKeywordChangeHandler} />
        <h2>{localeContext === "id" ? "Catatan" : "Notes List"}</h2>
        {loading === true ? (
          <CardList
            notes={filteredNotes}
